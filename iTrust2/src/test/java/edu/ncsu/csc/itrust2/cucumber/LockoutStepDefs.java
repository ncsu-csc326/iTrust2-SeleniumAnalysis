...
public class LockoutStepDefs extends SeleniumTest {
    ...
    public void verifyAccountBan () throws InterruptedException {
        seleniumWait( );
        assertTrue( driver.findElement( By.className( "alert-error" ) ).getText()
    ...
    public void verifyIPLock () throws InterruptedException {
        seleniumWait( );
        assertTrue( driver.findElement( By.className( "alert-error" ) ).getText()
    ...
    public void verifyIPBan () throws InterruptedException {
        seleniumWait( );
        assertTrue( driver.findElement( By.className( "alert-error" ) ).getText()
